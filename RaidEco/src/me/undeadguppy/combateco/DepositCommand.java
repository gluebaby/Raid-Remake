			...
			if (args.length == 1) {
				...
				try {
					...
					if (amount > count) {
						...
						player.sendMessage(ChatColor.GRAY + "You tried to deposit " + amount
								+ " gold, but you only have " + count + ".");
					...
					player.sendMessage(
							ChatColor.GRAY + "You have deposited " + amount + " gold into your bank account.");
				...
				player.sendMessage(ChatColor.GRAY + "Please use /deposit <amount>");
