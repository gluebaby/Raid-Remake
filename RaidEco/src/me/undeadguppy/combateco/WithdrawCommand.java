			...
			if (args.length == 1) {
				...
				try {
					...
					if (amount > balance) {
						...
						player.sendMessage(ChatColor.RED + "You tried to withdraw " + amount
								+ " gold, but your bank only has " + balance + ".");
					...
					player.sendMessage(
							ChatColor.GRAY + "You have withdrawn " + amount + " gold from your bank account.");
				...
				player.sendMessage(ChatColor.GRAY + "Please use /withdraw <amount>");
