...
public class StrengthEnchant extends CustomEnchantment {

	static final Material[] STRENGTH_ITEMS = new Material[] { Material.DIAMOND_HELMET, Material.DIAMOND_CHESTPLATE,
	...
	public StrengthEnchant() {
		super("Strength", STRENGTH_ITEMS, 2);
	...
	public void applyEquipEffect(Player p, int level) {
		p.addPotionEffect(new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 100000, level - 1));
	}
